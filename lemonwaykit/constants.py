...
VALID_LEMONWAY_METHOD_PARAMETERS = {
    ...
    'RegisterWallet': [
        ...
        "birthcity", "birthcountry", "isOneTimeCustomer", "payerOrBeneficiary", "isOneTimeCustomer", "isTechWallet",
    ],
    'UpdateWalletDetails': [
...
LEMONWAY_IBAN_STATUSES = [int(x) for x in LEMONWAY_IBAN_STATUS_DICT.keys()]
...
LEMONWAY_KYC_DOCUMENT_TYPES = [int(x) for x in LEMONWAY_KYC_DOCUMENT_TYPES_DICT.keys()]
...
LEMONWAY_KYC_DOCUMENT_STATUSES = [int(x) for x in LEMONWAY_KYC_DOCUMENT_STATUSES_DICT.keys()]
...
LEMONWAY_SDD_MANDATE_STATUSES = [int(x) for x in LEMONWAY_SDD_MANDATE_STATUSES_DICT.keys()]
...
LEMONWAY_WALLET_STATUSES = [int(x) for x in LEMONWAY_WALLET_STATUSES_DICT.keys()]
...
LEMONWAY_MONEYIN_STATUSES = [int(x) for x in LEMONWAY_MONEYIN_STATUSES_DICT.keys()]
...
LEMONWAY_P2P_PAYMENT_STATUSES = [int(x) for x in LEMONWAY_P2P_PAYMENT_STATUSES_DICT.keys()]
